...
/**
 * This component defines the tab layout for the application.
 * It includes tabs for Home, Saved, Create, Applied, and Profile screens.
 * The visibility of certain tabs is based on the user type (recruiter or job seeker).
 */
